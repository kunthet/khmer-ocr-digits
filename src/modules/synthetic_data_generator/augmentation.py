...
class ImageAugmentor:
    ...
    def rotate_image(self, image: Image.Image, angle: Optional[float] = None) -> Image.Image:
        """
        Rotate the image by a random or specified angle.
    ...
    def perspective_transform(self, image: Image.Image, 
        ...
        Returns:
            Perspective-transformed PIL image
        """
        if intensity is None:
        ...
        transformed = cv2.warpPerspective(img_array, perspective_matrix, (width, height),
